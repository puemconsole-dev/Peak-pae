...
// --- Mission List ---
int MissionList[] = {  
  303, 2, 401, 403, 304, 301, 303, 402, 100, 2, 100, 2, 110, 2, 304, 302, 303, 120, //BRO THIS SHIT IS RED 
  2, 100, 2, 401, 403, 304, 301, 303, 402, 1, 100, 1, 100, 1, 110, 1, 304, 302, 303, 120, //YELLOW YAY 
  4, 100, 2, 401, 403, 304, 301, 303, 402, 3, 304, 302, 303, 120,
  3, 100, 1, 401, 403, 304, 301, 303, 402, 100, 2, 100, 6, 304, 302, 303, 200
...
// 401, 403, 304, 301, 303, 402 เดินไปหยิบเว้ยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยย
// 304, 302, 303, 120 วางงงงงงงงงงเว้ยยยยยยยยยยยยยยยยยยยยยยยยยยย
...
void ExecuteTurn(bool isRight) {
  ...
  // หมุนตัว
  if(isRight) {
    sl(TurnSpeed); sleep(150); 
  } else {
    sr(TurnSpeed); sleep(150); 
  }

//void ExecuteTurnv2 wait 
...
void loop() {
  ...
  // 5. เดินตามเส้นปกติ (แก้กลับมาใช้ Logic แบบมาตรฐาน)
  bool L = analog(0)<threshold[0];
  bool R = analog(4)<threshold[4];
  
  // เจอแยก (ซ้าย+ขวา พร้อมกัน)
  if(L && R) { 
     CurrentCount++; 
     beep(); 
     ...
     if(CurrentCount >= Cmd) {
        ...
        motor(1, BaseSpeed); motor(2, BaseSpeed); 
        sleep(100); // ค่านี้สำคัญ! ต้องนานพอให้พ้นเส้นตัด (0.2 วิ)
     }
  } else {
     RunPID();
  }
